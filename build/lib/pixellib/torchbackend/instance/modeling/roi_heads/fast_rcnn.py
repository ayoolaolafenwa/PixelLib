...
from pixellib.torchbackend.instance.layers.wrappers import cat, nonzero_tuple, cross_entropy
from pixellib.torchbackend.instance.layers.nms import batched_nms
...
def fast_rcnn_inference_single_image(
    ...
    #print("filterzero")
    #filter_inds = torch.nonzero(filter_mask, as_tuple=True)
