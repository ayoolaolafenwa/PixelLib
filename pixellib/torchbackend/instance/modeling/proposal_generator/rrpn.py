...
from pixellib.torchbackend.instance.structures.rotated_boxes import pairwise_iou_rotated, RotatedBoxes
...
from pixellib.torchbackend.instance.modeling.proposal_generator.rpn import RPN
